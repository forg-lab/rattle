...
def sweep():
    ...
    play("e2", release=0.75, amp=0.4, cutoff=saw(8, 55, 110))
    sleep(0.5)
...
def bells():
    ...
    play(seq([76, 79, 83, 88], 1), amp=sine(6, 0.1, 0.26), release=2.2, room=0.6)
    sleep(1)
...
def width():
    ...
    play("a4", amp=0.14, release=0.92, pan=lambda t: (t % 4) / 2 - 1)
    sleep(0.5)
